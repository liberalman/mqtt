...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        ...
        [self.btnVoiceRecord setTitle:@"按住录音" forState:UIControlStateNormal];
        [self.btnVoiceRecord setTitle:@"释放发送" forState:UIControlStateHighlighted];
