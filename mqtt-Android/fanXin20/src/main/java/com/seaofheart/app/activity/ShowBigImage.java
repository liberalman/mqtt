...
import com.seaofheart.app.task.LoadLocalBigImgTask;
import com.seaofheart.app.utils.ImageCache;
import com.seaofheart.app.widget.photoview.PhotoView;
...
public class ShowBigImage extends BaseActivity {
	...
	private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
		...
		final HttpFileManager httpFileMgr = new HttpFileManager(this, ChatConfig.getInstance().getStorageUrl());
