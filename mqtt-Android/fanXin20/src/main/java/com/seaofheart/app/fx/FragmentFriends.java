...
import com.seaofheart.app.fx.others.ContactAdapter;
import com.seaofheart.app.widget.Sidebar;
...
public class FragmentFriends extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // 黑名单列表
        blackList = ContactManager.getInstance().getBlackListUsernames();
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if(position!=0&&position!=contactList.size()+1){
                    ...
                    .putExtra("hxid", username ).putExtra("nick", user.getNick() ).putExtra("avatar", user.getAvatar() ).putExtra("sex", user.getSex() ).putExtra("region", user.getRegion() ));
                }
