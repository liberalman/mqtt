...
public class CallActivity extends BaseActivity {
    ...
    protected void saveCallRecord(int type) {
        ...
        if (!isInComingCall) { // 打出去的通话
            message = Message.createSendMessage(ProtocolMessage.TYPE.TXT);
            message.setReceipt(username);
        } else {
            message = Message.createReceiveMessage(ProtocolMessage.TYPE.TXT);
        ...
        // 保存
        ChatManager.getInstance().saveMessage(message, false);
    }
