...
import com.seaofheart.app.fx.others.ConversationAdapter;
...
public class FragmentCoversation extends Fragment {
    ...
    private List<Conversation> normal_list = new ArrayList<Conversation>();
    private List<Conversation> top_list = new ArrayList<Conversation>();
    ...
    private List<Conversation> loadConversationsWithRecentChat() {
        // 获取所有会话，包括陌生人
        Hashtable<String, Conversation> conversations = ChatManager
                .getInstance().getAllConversations();

        List<Conversation> list = new ArrayList<Conversation>();
        List<Conversation> topList1 = new ArrayList<Conversation>();
        ...
        for (Conversation conversation : conversations.values()) {
            ...
            if (conversation.getAllMessages().size() != 0) {
                ...
                //
                // for(Message msg:conversation.getAllMessages()){
     ...
     */
    private void sortConversationByLastChatTime(List<Conversation> conversationList) {
        Collections.sort(conversationList, new Comparator<Conversation>() {
            ...
            public int compare(final Conversation con1,
                ...
                Message con2LastMessage = con2.getLastMessage();
                Message con1LastMessage = con1.getLastMessage();
