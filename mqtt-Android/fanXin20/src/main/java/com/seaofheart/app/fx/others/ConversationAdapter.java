...
public class ConversationAdapter extends BaseAdapter {
    ...
    private List<Conversation> top_list;
    ...
    public ConversationAdapter(Context context, List<Conversation> normal_list, List<Conversation> top_list, Map<String, TopUser> topMap) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!isGroup) {
            ...
            if (user != null) {
                ...
                if(message.direct == ProtocolMessage.DIRECT.RECEIVE){ // 收消息
                    try {
        ...
        if (conversation.getMsgCount() != 0) {
            ...
            holder.tv_content.setText(SmileUtils.getSmiledText(context, getMessageDigest(lastMessage, context)), BufferType.SPANNABLE);
            holder.tv_time.setText(DateUtils.getTimestampString(new Date(lastMessage.getMsgTime())));
            if (lastMessage.direct == ProtocolMessage.DIRECT.SEND && lastMessage.status == ProtocolMessage.STATUS.FAIL) {
    ...
    private void showMyDialog(String title, final Conversation conversation) {
        ...
        tv_content2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ChatManager.getInstance().deleteConversation(
