    ...
    public static HanziToPinyin getInstance() {
        ...
        synchronized(HanziToPinyin.class) {
            if(sInstance != null) {
                ...
                com.easemob.util.EMLog.w("HanziToPinyin", "There is no Chinese collator, HanziToPinyin is disabled");
                sInstance = new HanziToPinyin(true);
                return sInstance;
            }
        }
    ...
    private static boolean doSelfValidation() {
        ...
        for(int var3 = 0; var3 < var4; ++var3) {
            ...
            if(var0 != var2) {
                ...
                if(var7 >= 0) {
                    com.easemob.util.EMLog.e("HanziToPinyin", "Internal error in Unihan table. The last string \"" + var1 + "\" is greater than current string \"" + var6 + "\".");
                    return false;
                }
