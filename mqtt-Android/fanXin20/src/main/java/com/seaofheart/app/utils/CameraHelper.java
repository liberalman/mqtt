 ...
 */
package com.seaofheart.app.utils;
...
public class CameraHelper implements PreviewCallback {
    ...
    private VideoCallHelper callHelper;

    public CameraHelper(VideoCallHelper callHelper, SurfaceHolder localSurfaceHolder) {
    ...
    public void startCapture(){
        try {
            ...
            VideoCallHelper.getInstance().setResolution(mwidth, mheight);
