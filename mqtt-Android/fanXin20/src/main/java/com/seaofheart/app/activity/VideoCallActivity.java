...
import com.seaofheart.app.chat.CallStateChangeListener;
import com.seaofheart.app.chat.ChatManager;
import com.seaofheart.app.chat.VideoCallHelper;
import com.seaofheart.app.exceptions.ServiceNotReadyException;
import com.seaofheart.app.R;
import com.seaofheart.app.utils.CameraHelper;
...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callHelper = VideoCallHelper.getInstance();
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            ...
            if (!cameraHelper.isStarted()) {
                if (!isInComingCall) {
                    try {
                        // 拨打视频通话
                        ChatManager.getInstance().makeVideoCall(username);
    ...
    void addCallStateListener() {
        ...
        ChatManager.getInstance().addVoiceCallStateChangeListener(callStateListener);
    }
    ...
    public void onClick(View v) {
        ...
        case R.id.btn_refuse_call: // 拒绝接听
            if (ringtone != null)
                ringtone.stop();
            try {
                ChatManager.getInstance().rejectCall();
            } catch (Exception e1) {
                e1.printStackTrace();
                saveCallRecord(1);
                finish();
        ...
        case R.id.btn_answer_call: // 接听电话
            ...
            if (isInComingCall) {
                try {
                    isAnswered = true;
                    ChatManager.getInstance().answerCall();
                    cameraHelper.setStartFlag(true);
        ...
        case R.id.btn_hangup_call: // 挂断电话
            ...
            try {
                ChatManager.getInstance().endCall();
            } catch (Exception e) {
                e.printStackTrace();
                saveCallRecord(1);
                finish();
