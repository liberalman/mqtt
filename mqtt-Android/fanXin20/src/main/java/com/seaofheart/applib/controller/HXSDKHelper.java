 ...
 */
package com.seaofheart.applib.controller;
...
public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit(Context context){
        ...
        // 初始化环信SDK,一定要先调用init()
        Chat.getInstance().init(context);
        
        // 设置sandbox测试环境
        // 建议开发者开发时设置此模式
        if(hxModel.isSandboxMode()){
            Chat.getInstance().setEnv(EnvMode.EMSandboxMode);
        }
    ...
    /**
     * please make sure you have to get ChatOptions by following method and set related options
     *      ChatOptions options = ChatManager.getInstance().getChatOptions();
     */
    ...
    public void logout(final CallBack callback){
        ChatManager.getInstance().logout(new CallBack(){
    ...
    protected void initListener(){
        ...
        ChatManager.getInstance().addConnectionListener(connectionListener);
    }
